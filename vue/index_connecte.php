...
<div class="bloc_configuration">
    <form action="../vue/changer_infos.php" method="post">
...
<div class="bloc_configuration">
    <form action="../vue/traduction/affichage_demandes_traduction.php" method="post">
...
<div class="bloc">
    <form action="index_connecte.php" method="post">
